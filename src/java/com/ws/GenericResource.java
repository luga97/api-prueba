...
public class GenericResource {
    ...
    public String Api(String request) throws SQLException{
        ...
        try {
            ...
            ob.put("huella_template_ansi378", jRequest.getString("huella_template_ansi378"));
            con.insertUpdate(jRequest.getString("nombre"),jRequest.getString("cedula"), jRequest.getString("huella_imagen"), jRequest.getString("huella_template_iso19794"), jRequest.getString("huella_template_ansi378"));
